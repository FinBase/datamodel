...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `at_mjst_finbase`.`tav_tra_aggregated` (`acc_id` INT, `balance` INT, `value_date_from` INT, `value_date_to` INT);
